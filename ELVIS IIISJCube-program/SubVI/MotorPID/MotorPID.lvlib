...
<Library LVVersion="19008000">
	...
	<Item Name="MainRunExp.vi" Type="VI" URL="../MainRunExp.vi"/>
	<Item Name="MotorPosCtrl(deg).vi" Type="VI" URL="../MotorPosCtrl(deg).vi"/>
	<Item Name="RunState.ctl" Type="VI" URL="../RunState.ctl"/>
	<Item Name="StepMotorSpeedCtrl.vi" Type="VI" URL="../StepMotorSpeedCtrl.vi"/>
	<Item Name="StickEncoder.vi" Type="VI" URL="../StickEncoder.vi"/>
</Library>
